...
<head>
    ...
    <title>National Film Corporation</title>
...
<div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="{{ url('/home') }}" class="brand-link">
            <img src="{{ asset('lte/dist/img/nfc.png') }}" alt="AdminLTE Logo"
                 class="brand-image img-circle elevation-3"
                 style="opacity: .8">
            <span class="brand-text font-weight-light">NFC - CCSMA</span>
        </a>
        ...
        <div class="sidebar">
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                <div class="image">
                    <img src="{{ Auth::user()->filename ? url('uploads/'.Auth::user()->filename) : asset('lte/dist/img/user2-160x160.jpg') }}" class="img-circle elevation-2"
                         alt="User Image">
                </div>
                <div class="info">
                    <a href="{{action('UserController@show',  Auth::user()->id)}}" class="d-block">{{ Auth::user()->name }} </a>
                </div>
            </div>
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                    ...
                    <li class="nav-item has-treeview">
                        <a href="{{ url('/reports') }}" class="nav-link">
                            ...
                            <p>
                                ...
                                <span
                                    class="badge badge-info right">{{Auth::user()->role == 1 || Auth::user()->role == 2 ? 8:5}}</span>
                            </p>
                        </a>
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                    ...
                    <li class="nav-item has-treeview">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ url('/movie-sales') }}" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Movie Sales</p>
                                </a>
                            </li>
    ...
    <footer class="main-footer">
        <strong>Copyright &copy; 2020 <a href="">National Film Corporation</a>.</strong>
        All rights reserved.
